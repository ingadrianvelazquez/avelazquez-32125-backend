...
import { productControllerGet, productControllerCreate, productByCategoryControllerGet } from '../controllers/product.controller.js'
import ProductDaoFactory from '../daos/product/ProductDaoFactory.js'
const catalog = ProductDaoFactory.getDaoSource();

productRouter.get('/bycategory/:category', productByCategoryControllerGet)
